...
void Vehicle_onFire2(CBlob@ this, VehicleInfo@ v, CBlob@ bullet, const u8 charge) {}
...
bool Vehicle_canFire2(CBlob@ this, VehicleInfo@ v, bool isActionPressed, bool wasActionPressed, u8 &out chargeValue)
{
	u8 charge = v.charge;
				...
				if (ap.name == "GUNNER" && !isKnocked(blob))
				{
					...
					switch (style)
					{
							...
							//custom firing requirements
						{
							...
							else if (Vehicle_canFire2(this, v, ap.isKeyPressed(key_action1), ap.wasKeyPressed(key_action1), charge) && canFire(this, v) && blob.isMyPlayer())
							{
								CBitStream fireParams;
								fireParams.write_u16(blob.getNetworkID());
