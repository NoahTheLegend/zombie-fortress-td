...
const f32 archer_grapple_length = 0.2f;
const f32 archer_grapple_slack = 1.0f;
const f32 archer_grapple_throw_speed = 1.0f;

const f32 archer_grapple_force = 0.2f;
const f32 archer_grapple_accel_limit = 0.2f;
const f32 archer_grapple_stiffness = 0.2f;
