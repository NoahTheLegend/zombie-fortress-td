...
void onInit(CBlob@ this)
{
	...
	this.SetMinimapVars("mipmip.png", icon_frame, Vec2f(8, 32));
...
void UpdateMinimapIcon(CBlob@ this, TreeVars@ vars)
{
	...
	{
		this.SetMinimapVars("mipmip.png", 8, Vec2f(8, 32));
	}
	else if (vars.grown_times < 10)
	{
		this.SetMinimapVars("mipmip.png", 10, Vec2f(8, 32));
	}
	else
	{
		this.SetMinimapVars("mipmip.png", 12, Vec2f(8, 32));
	}
}