...
class PNGLoader
{
	...
	void handlePixel(const SColor &in pixel, int offset)
	{
		...
		else
		{
			...
			case map_colors::color_zombie_main_spawn: autotile(offset); AddMarker(map, offset, "zombie spawn");  break;
			case map_colors::color_zombie_portal: 	  autotile(offset); AddMarker(map, offset, "zombie portal"); break;
			// Water
